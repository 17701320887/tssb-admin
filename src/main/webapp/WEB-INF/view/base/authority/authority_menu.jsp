...
<body>
         <div>
			<div class="row">
			    <div class="col-md-6" style="width:30%;">
                    <div class="panel panel-inverse" data-sortable-id="tree-view-3">
                        ...
                        <div class="panel-body" style="height:600px;overflow: auto;">
                            <ul id="jstree-menu" class="ztree" style="overflow: auto">
                            </ul>
                        </div>
                    </div>
			    </div>
               ...
               <%--                 <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
                        ...
                        <div id="menuBody" class="panel-body" style="display: none;height: 600px;">
                            <form id="menuForm" class="form-horizontal form-bordered" data-parsley-validate="true">
                                ...
                                <shiro:hasPermission name="menu:operManage:0">
                                <div class="form-group" level="2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       <shiro:hasPermission name="menu:update:0">
        ...
        <%@include file="/WEB-INF/view/base/authority/menu_dialog.jsp" %>
