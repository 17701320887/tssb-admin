                ...
                <div class="panel-body">
                    <form class="form-inline">
                        ...
                        <div class="form-group m-r-10">
                            <input type="text" class="form-control"  style="width:220px;" id="name" placeholder="用户姓名" />
                        </div>
                        <div class="form-group m-r-10">
                            <input type="text" class="form-control" style="width:220px;" id="mobile" placeholder="用户手机" />
                        </div>
                        <div class="form-group m-r-10">
                            <input type="text" class="form-control"  style="width:220px;"  id="wxNo" placeholder="用户微信" />
                        </div>
                        <div class="form-group  m-r-10" >
