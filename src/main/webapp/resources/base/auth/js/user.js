...
function formCheck(){
    formInit();
    if($.trim(userForm.find("#wxNo").val())==""){
        userForm.find("#wxNo").parent().parent().addClass("has-error has-feedback");
        userForm.find("#wxNo").parent().find("li").html("微信号不能为空!");
        return false;
    }
    ...
    if($.trim(userForm.find("#workNo").val())==""){
        userForm.find("#workNo").parent().parent().addClass("has-error has-feedback");
        userForm.find("#workNo").parent().find("li").html("工号不能为空!");
        return false;
    }
    return true;
}
...
function editClick(id,wxNo,name,mobile,workNo){
    $("#editId").val(id);
    cleanData();
    $("#userWxNo_edit").val(wxNo);
    $("#usermobile_edit").val(name);
    $("#username_edit").val(mobile);
    $("#workNo_edit").val(workNo);
}
...
$("#editUser").click(function(){
    alert("aaa");
    var datas = {"id":$("#editId").val(),"name":$.trim($("#username_edit").val()),"mobile":$.trim($("#usermobile_edit").val()),"wxNo":$.trim($("#userWxNo_edit").val()),
        "workNo":$.trim($("#workNo_edit").val())};
    console.log(datas);
    $.ajax({
